(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["laravel-leo"] = factory();
	else
		root["laravel-leo"] = factory();
})(this, function() {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    getActionByUriKey(uriKey) {
      return _(this.resourceData.actions).filter(action => action.uriKey === uriKey).first();
    },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  watch: {
    value(data) {
      Leo.$emit(this.field.attribute + '-' + this.resourceId + '-value-change', data);
    }
  ...
  mounted() {
    ...
    Leo.$on(this.field.attribute + '-' + this.resourceId + '-value', value => {
      this.value = value;
    });
  },

  destroyed() {
    Leo.$off(this.field.attribute + '-' + this.resourceId + '-value-change');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_form_backend_validation__ = __webpack_require__(1);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  methods: {
     ...
     */
    toAppTimezone(value) {
      return value ? moment.tz(value, this.userTimezone).clone().tz(Leo.config.timezone).format('YYYY-MM-DD HH:mm:ss') : value;
    },
    ...
    fromAppTimezone(value) {
      ...
      return moment.tz(value, Leo.config.timezone).clone().tz(this.userTimezone).format('YYYY-MM-DD HH:mm:ss');
    },
    ...
    localizeDateTimeField(field) {
      ...
      const localized = moment.tz(field.value, Leo.config.timezone).clone().tz(this.userTimezone);
  ...
  computed: {
     ...
     */
    userTimezone() {
      return Leo.config.userTimezone ? Leo.config.userTimezone : moment.tz.guess();
    },
  ...
  methods: {
    getResourceFormData() {
      return _.tap(new FormData(), formData => {
        _(this.dataFields.fields).each(field => field.fill(formData)); // formData.append('_method', 'PUT')
    ...
    mountedResourceSelected() {
      ...
      Leo.$on(this.resourceId + '-resource-selected-set', data => this.resourceSelected = data);
      Leo.$on(this.resourceId + '-resource-selected-get', callback => callback(this.resourceSelected));
...
var Form = function () {
    ...
    _createClass(Form, [{
        ...
        value: function withOptions(options) {
            ...
            this.__http = options.http || windowAxios || __webpack_require__(17);
...
var _formData = __webpack_require__(36);
...
var _fieldNameValidation = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_FormField__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins_HandlesValidationErrors__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_IndexField__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins_Resource__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mixins_InteractsWithDates__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mixins_Action__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_form_backend_validation__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_form_backend_validation___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_form_backend_validation__);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "FormField", function() { return __WEBPACK_IMPORTED_MODULE_0__mixins_FormField__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "HandlesValidationErrors", function() { return __WEBPACK_IMPORTED_MODULE_1__mixins_HandlesValidationErrors__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "IndexField", function() { return __WEBPACK_IMPORTED_MODULE_2__mixins_IndexField__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Resource", function() { return __WEBPACK_IMPORTED_MODULE_3__mixins_Resource__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "InteractsWithDates", function() { return __WEBPACK_IMPORTED_MODULE_4__mixins_InteractsWithDates__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Action", function() { return __WEBPACK_IMPORTED_MODULE_5__mixins_Action__["a"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_6_form_backend_validation__, "Errors")) __webpack_require__.d(__webpack_exports__, "Errors", function() { return __WEBPACK_IMPORTED_MODULE_6_form_backend_validation__["Errors"]; });
// Mixins
